...
const navItems: NavItem[] = [
  ...
  // Phase 2
  { href: "/email", label: "Email Hub", icon: Mail, phase: 2, enabled: false },
  { href: "/finance", label: "Finance", icon: Wallet, phase: 2, enabled: false },
  { href: "/compliance", label: "Compliance", icon: Building2, phase: 2, enabled: false },
  { href: "/journal", label: "Daily Journal", icon: BookOpen, phase: 2, enabled: false },
  { href: "/settings", label: "Settings", icon: Settings, phase: 2, enabled: false },
  { href: "/skills", label: "Skills", icon: Puzzle, phase: 2, enabled: false },
  { href: "/terminal", label: "Terminal", icon: SquareTerminal, phase: 2, enabled: false },
  { href: "/backup", label: "Backup Manager", icon: HardDrive, phase: 2, enabled: false },
  // Phase 3
