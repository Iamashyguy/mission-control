...
export function StatsCard({ title, value, icon, iconColor = "var(--info)", trend, subtitle }: StatsCardProps) {
  return (
    <div
    ...
    >
      ...
      <div className="flex items-end justify-between">
        ...
        {trend && (
          <span className="text-xs md:text-sm font-medium" style={{ color: trend.isPositive ? "var(--success)" : "var(--error)" }}>
