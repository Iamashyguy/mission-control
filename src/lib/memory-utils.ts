...
// Logger shim (MC builderz has a full logger, we use console)
const logger = {
  info: (...args: unknown[]) => console.log('[memory-utils]', ...args),
  warn: (...args: unknown[]) => console.warn('[memory-utils]', ...args),
  error: (...args: unknown[]) => console.error('[memory-utils]', ...args),
}
